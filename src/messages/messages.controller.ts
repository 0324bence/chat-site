...
import { SendTextMessageDto, GetMessagesBetweenUsersDto, GetMessagesBetweenUsersResultDto } from "./message.dto";
...
export class MessagesController {
    ...
    @ApiOkResponse({ type: GetMessagesBetweenUsersResultDto, isArray: true })
